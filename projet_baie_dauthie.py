...
input_path = input("Veuillez indiquer votre base de donnée avec fichiers d'entrée \n")
...
output_ask = input("Veuillez rentrer le dossier de resultats \n")
out_name = input("Veuillez indiquer le nom de votre geodatabase de resultats \n")
...
if arcpy.Exists(os.path.join(output_ask, out_name)):
    arcpy.management.Delete(os.path.join(output_ask, out_name))
    print("Ancienne gdb supprimée")
arcpy.management.CreateFileGDB(output_ask, out_name, "")
print ("Nouvelle gdp créée")

#Définition des environnements 2
print("Suite définition des environnements")
output_path = f"{output_ask}/{out_name}"
arcpy.env.workspace = output_path

#Définition des variables
print("Définition des variables")

ask_chem = input("Voulez vous entrer vous-même les nom des fichiers ? O/N \n")
if ask_chem ==  "O" :
    nom_cadastre80batiments = input("Donnez ci dessous le nom du fichier 'cadastre80batiments' \n") 
    nom_Communes_France = input("Donnez ci dessous le nom du fichier 'Commune_France' \n")
    nom_MNT_RGF93_5m = input("Donnez ci dessous le nom du fichier 'MNT_RGF93_5m' \n")
    nom_occup_sol = input("Donnez ci dessous le nom du fichier issue de la télédétéction \n")
